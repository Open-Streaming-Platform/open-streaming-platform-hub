...
serverAdd.add_argument('address', type=str, required=True, location='form')
serverAdd.add_argument('protocol', type=str, required=True, location='form')

serverDelete = reqparse.RequestParser()
serverDelete.add_argument('id', type=str, required=True, location='form')
serverDelete.add_argument('token', type=str, required=True, location='form')
